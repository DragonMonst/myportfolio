  ...
  const awards = [
    {
      ...
      year: '2025',
      description: 'Represented Vietnam in a two-day international competitive programming contest hosted by Romania for their 2026 International Olympiad in Informatics’ national representative selection process. Claimed Bronze Medal for individual performance among participants from 13 countries, including Romania, Vietnam, Singapore, etc.',
      icon: FaMedal,
    ...
    },
    {
      ...
      year: '2025',
      description: 'Participated in a 5-hour regional ICPC competitive programming contest. Solved 6 of 13 problems as a team of three, independently solving 3 problems.',
      icon: GiTrophyCup,
      iconColor: 'orange.500',
      bgGradient: 'linear(135deg, #f59e0b 0%, #d97706 100%)',
      borderColor: 'orange.300',
    ...
    {
      title: 'Third Prize x Honorable Mention',
      organization: 'Vietnam Olympiad in Informatics',
      year: '2025 & 2024',
      description: 'Selected twice as one of ten representatives for the school’s team in the national Informatics competition for all high school students across Vietnam. Claimed Third Prize in 2025 after earning a Honorable Mention in 2024 for individual performance.',
      icon: FaCertificate,
    ...
    },
    {
      ...
      year: '2024',
      description: 'Participated in the chess tournament for local youth and claimed Second Place in the 16-18 age bracket.',
      icon: FaChess,
      iconColor: 'green.500',
